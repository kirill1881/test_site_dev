    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_answer', models.CharField(blank=True, choices=[('1', models.CharField(max_length=150)), ('2', models.CharField(max_length=150)), ('3', models.CharField(max_length=150)), ('4', models.CharField(max_length=150))], max_length=150)),
